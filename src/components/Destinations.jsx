...
const seedTours = [
  ...
  {
    id: 't5',
    title: 'Египет: Дайвинг в Красном море',
    price: 840,
    nights: 7,
    rating: 4.5,
    country: 'Египет',
  ...
  return (
    <section id="destinations" className="container py-16">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {seedTours.map((t, idx) => {
          const prompt =
            `Подбери тур: ${t.country}. Вариант "${t.title}", на ${t.nights} ночей. ` +
            `Ориентир по бюджету ~ ${fmtMoney(t.price)} за человека. Предложи 3 альтернативы и уточни даты/предпочтения.`;
          ...
          return (
            ...
            >
              <div className="relative h-44 w-full sm:h-52 md:h-60">
                ...
                <div className="absolute right-3 top-3 rounded-full bg-white/90 px-3 py-1 text-sm font-semibold">
                  от {fmtMoney(t.price)}
                </div>
              </div>
              ...
              <div className="p-4">
                <div className="text-slate-600">
                  {t.nights} ночей • рейтинг {t.rating}
                </div>
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-sky-500 to-indigo-600 px-5 py-3 font-semibold text-white"
                >
